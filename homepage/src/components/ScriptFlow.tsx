...
const scriptData: Record<string, ScriptStep> = {
  'welcome': {
    id: 'welcome',
    message: `Hey boss, CJ here. Here's what I handled while you slept:
• Tickets yesterday: 220 → Auto-resolved 160 (73%)
...
💎 VIP Watch
LTV $842 customer delayed 5 days; suggest $20 credit.

Where do you want to dive first?`,
    chips: [
...
const ScriptFlow: React.FC<ScriptFlowProps> = ({ className = '', onComplete }) => {
