...
class FreshdeskUnifiedTicketView(Base):
    ...
    freshdesk_ticket_id = Column(String(255), primary_key=True)
    ticket_id_numeric = Column(Integer)
    ...
    fr_due_by = Column(DateTime(timezone=True))
    nr_due_by = Column(DateTime(timezone=True))
    
    # Stats
    first_responded_at = Column(DateTime(timezone=True))
    agent_responded_at = Column(DateTime(timezone=True))
    requester_responded_at = Column(DateTime(timezone=True))
    closed_at = Column(DateTime(timezone=True))
    resolved_at = Column(DateTime(timezone=True))
    reopened_at = Column(DateTime(timezone=True))
    pending_since = Column(DateTime(timezone=True))
    ...
    has_agent_response = Column(Boolean)
    
    # Rating Info
    has_rating = Column(Boolean)
    rating_score = Column(Integer)
    rating_feedback = Column(String)
    rating_created_at = Column(DateTime(timezone=True))
